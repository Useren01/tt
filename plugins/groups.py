...
async def mute(c,msg):
  ...
  try :
    ...
    if msg.reply_to_message.from_user.id == 2095537199 :
      return await msg.edit("• لا يمكنك كتم تيركس")
...
async def un_mute(c,msg):
  try :
    ...
    if msg.reply_to_message.from_user.id == 2095537199 :
      return await msg.edit("• لا يمكنك الغاء كتم تيركس")
...
async def bann(c,msg):
  ...
  if msg.reply_to_message.from_user.id == 2095537199 :
    return await msg.edit("• لا يمكنك حظر تيركس")
  try :
...
async def un_ban(c,msg):
  ...
  if msg.reply_to_message.from_user.id == 2095537199 :
    return await msg.edit("• لا يمكنك الغاء حظر تيركس")
  try :
