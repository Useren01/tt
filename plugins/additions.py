...
@Client.on_message(filters.command("مسح الكل$",prefixes=f".") & filters.me )
async def deeee(client, message):
...
async def source(c,msg):
  await msg.edit("• [Fast Source](https://t.me/otlop12)\n• [Mahmoud](https://t.me/FPFFG)")
...
@Client.on_message(filters.command("بحث$",prefixes=f".") )
